...
export const BUSINESSES: Business[] = [
  {
    ...
    summary: "MCP サーバーを、本番品質でホスティングするプラットフォーム。",
    description:
    ...
    features: [
      "MCP サーバーのマネージドホスティング",
      "オートスケーリングと高可用性",
      "アクセス制御・監査ログによるエンタープライズ対応",
      "エッジ配信による低レイテンシ",
    ],
  },
  {
    ...
    summary: "高速な WebAssembly ソリューションの設計・開発。",
    description:
      "Rust・Go を用いた WebAssembly ソリューションの設計から実装までを一貫して支援します。ブラウザ・エッジ・サーバーサイドを問わず、ネイティブに迫るパフォーマンスと高い移植性を両立する実装を提供します。",
    features: [
      "Rust / Go による WebAssembly モジュール開発",
      "ブラウザ・エッジ・サーバーサイドでの実行最適化",
      "既存アプリケーションへの段階的な組み込み",
      "パフォーマンス計測とチューニング",
    ],
  },
  {
    ...
    summary: "脆弱性診断から修正対応、セキュリティ改善まで。",
    description:
      "Web アプリケーション・インフラの脆弱性診断を行い、発見した問題の修正対応、そして継続的なセキュリティ改善までを支援します。診断して終わりではなく、直し切るところまで伴走します。",
    features: [
      "脆弱性診断（Web アプリケーション / インフラ）",
      "検出された脆弱性の修正対応",
      "セキュアコーディング・設計レビュー",
      "継続的なセキュリティ改善の仕組みづくり",
    ],
...
export const PHILOSOPHY = {
  ...
  value: {
    ...
    items: [
      {
        title: "品質第一",
        body: "動くだけでなく、直し切る。長く使える品質にこだわります。",
      },
      {
        title: "誠実さ",
        body: "できること・できないことを正直に伝え、期待を握ってから進めます。",
      },
      {
        title: "技術への探究",
        body: "一次情報とドキュメントを重んじ、確かな理解に基づいて実装します。",
      },
      {
        title: "顧客の成功",
        body: "納品ではなく、顧客のビジネス成果をゴールに置きます。",
      },
    ],
  },
} as const;
